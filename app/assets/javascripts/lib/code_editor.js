    ...
    proto = {
        ...
        render: function () {
            ...
            if (that.copiable) {
                ...
                if (!_hasClipboard) {
                    //ZeroClipboard.config({swfPath: '/assets/images/ZeroClipboard.swf'});
                    _hasClipboard = true;
                    $('head').append([
                        '<style>',
                ...
                $editor.append('<button class="btn btn-default codeeditor-copy-button" type="button">Copy to clipboard</button>');
